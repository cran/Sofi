...
[![Build Status](https://travis-ci.org/loerasg/Sofi.svg?branch=master)](https://travis-ci.org/loerasg/Sofi) [![CRAN version](http://www.r-pkg.org/badges/version/Sofi)](https://cran.r-project.org/package=Sofi)
